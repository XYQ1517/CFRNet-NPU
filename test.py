...
from modeling.CFRNet import CFRNet
...
def main():
    ...
    parser.add_argument('--out-path', type=str, default='./run/IRDS/',
                        help='mask image to save')
    parser.add_argument('--batch-size', type=int, default=1,
                        metavar='N', help='input batch size for test ')
    parser.add_argument('--ckpt', type=str, default='./run/IRDS/CFRNet/model_best.pth.tar',
                        help='saved model')
    ...
    parser.add_argument('--dataset', type=str, default='IRDS',
    ...
    out_path = os.path.join(args.out_path, 'Output', 'CFRNet/')
